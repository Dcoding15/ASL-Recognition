...
from models import AttentionCNNBiLSTM
...
model = AttentionCNNBiLSTM(num_classes=num_classes).to(device)
...
torch.save(model.state_dict(), 'pre trained weigths/cnn_bi_lstm_attention_weights.pth')
